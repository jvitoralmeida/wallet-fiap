...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        final var user1 = User.builder().cpf("1234").birthDate(LocalDate.now()).email("usuario1@gmail.com").password("senhadificil").name("fulano").build();
        final var user2 = User.builder().cpf("12345").birthDate(LocalDate.now()).email("usuario2@gmail.com").password("senhadificil").name("ciclano").build();
        final var user3 = User.builder().cpf("12346").birthDate(LocalDate.now()).email("usuario3@gmail.com").password("senhadificil").name("beltrano").build();
